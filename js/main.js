...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const SERVICES = [
    ...
    ["compactadoras", "Compactadoras fijas", '<path d="M4 9.5h16a1 1 0 0 1 1 1V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-9.5a1 1 0 0 1 1-1Z"/><rect x="5.5" y="11.5" width="13" height="2.4" rx=".7" fill="rgba(8,19,10,.45)"/><path d="M7 17.2h10M7 19h10" stroke="rgba(8,19,10,.3)" stroke-width="1.2" stroke-linecap="round"/><path d="M12 2v5.2M9.4 4.8 12 7.4l2.6-2.6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>'],
    ...
    ["depositos", "Contenedores urbanos", '<rect x="10" y="2" width="4" height="4" rx="1"/><rect x="10" y="5" width="4" height="12" rx="1" fill="rgba(8,19,10,.25)"/><path d="M6 9a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v9a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2Z"/><path d="M9 12v6M12 12v6M15 12v6" stroke="rgba(8,19,10,.35)" stroke-width="1.3" stroke-linecap="round"/>'],
  ];
